...
#save PCoA#
ggsave(filename = "Lab_Notebook/Beta_Diversity_Analysis/AIM_2B/AIM_2B_PT2/2B_2_unweighted_pcoa.png"
       , gg_pcoa_unifrac
       , height=4, width=8)
...
#save PCoA#
ggsave(filename = "Lab_Notebook/Beta_Diversity_Analysis/AIM_2B/AIM_2B_PT2/2B_2_weighted_pcoa.png"
       , gg_pcoa_wunifrac
       , height=4, width=8)
...
#save PCoA#
ggsave(filename = "Lab_Notebook/Beta_Diversity_Analysis/AIM_2B/AIM_2B_PT2/2B_2_jaccard_pcoa.png"
       , gg_pcoa_jaccard
       , height=4, width=8)
...
#save PCoA#
ggsave(filename = "Lab_Notebook/Beta_Diversity_Analysis/AIM_2B/AIM_2B_PT2/2B_2_bc_pcoa.png"
       , gg_pcoa_bc
       , height=4, width=8)