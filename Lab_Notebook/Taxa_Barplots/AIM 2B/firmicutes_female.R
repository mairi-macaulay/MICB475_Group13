...
data_rel_proteobacteria$sheetwashfreq_binned = factor(data_rel_proteobacteria$sheetwashfreq_binned, levels = c("low","medium","high")) #create the order for low, medium, high in the plot
