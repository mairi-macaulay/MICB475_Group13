...
#save PCoA#
ggsave(filename = "Lab_Notebook/Beta_Diversity_Analysis/AIM_1A/AIM_1A_PT3/1A_3_unweighted_pcoa.png"
       , gg_pcoa_unifrac
       , height=4, width=5)
...
#save PCoA#
ggsave(filename = "Lab_Notebook/Beta_Diversity_Analysis/AIM_1A/AIM_1A_PT3/1A_3_weighted_pcoa.png"
       , gg_pcoa_wunifrac
       , height=4, width=5)
...
#save PCoA#
ggsave(filename = "Lab_Notebook/Beta_Diversity_Analysis/AIM_1A/AIM_1A_PT3/1A_3_jaccard_pcoa.png"
       , gg_pcoa_jaccard
       , height=4, width=5)
...
#save PCoA#
ggsave(filename = "Lab_Notebook/Beta_Diversity_Analysis/AIM_1A/AIM_1A_PT3/1A_3_bc_pcoa.png"
       , gg_pcoa_bc
       , height=4, width=5)