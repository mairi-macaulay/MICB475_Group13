...
plot_shannon_gender_sheetwashfreq <- ggplot(samp_dat_wdiv) + geom_boxplot(aes(x=sheetwashfreq_binned, y=Shannon)) +
...
# run the 2-way ANOVA
shannon_sheetwashfreq_gender <- lm(Shannon ~ `sex`*`sheetwashfreq_binned`, data=samp_dat_wdiv)
summary(aov(shannon_sheetwashfreq_gender))
TukeyHSD(aov(shannon_sheetwashfreq_gender))

#Results: no significant comparisons

#save plot
ggsave(filename = "2B_plot_shannon.png"
       , plot_shannon_gender_sheetwashfreq
       , height=4, width=6)

#####Observed#####
# plot the sheetwashfreq and gender against Observed
plot_observed_gender_sheetwashfreq <- ggplot(samp_dat_wdiv) + geom_boxplot(aes(x=sheetwashfreq_binned, y=Observed)) +
  facet_grid(~factor(`sex`, levels=c("female","male"))) +
  xlab("Sheet Wash Frequency") +
  scale_x_discrete(limits = c("low", "medium", "high"))
...
# run the 2-way ANOVA
observed_sheetwashfreq_gender <- lm(Observed ~ `sex`*`sheetwashfreq_binned`, data=samp_dat_wdiv)
...
#save plot
ggsave(filename = "2B_plot_observed.png"
       , plot_observed_gender_sheetwashfreq
       , height=4, width=6)

#####Chao1#####
# plot the sheetwashfreq and gender against Chao1
plot_chao1_gender_sheetwashfreq <- ggplot(samp_dat_wdiv) + geom_boxplot(aes(x=sheetwashfreq_binned, y=Chao1)) +
  facet_grid(~factor(`sex`, levels=c("female","male"))) +
  xlab("Sheet Wash Frequency") +
  scale_x_discrete(limits = c("low", "medium", "high"))
...
# run the 2-way ANOVA
chao1_sheetwashfreq_gender <- lm(Chao1 ~ `sex`*`sheetwashfreq_binned`, data=samp_dat_wdiv)
...
#save plot
ggsave(filename = "2B_plot_chao1.png"
       , plot_chao1_gender_sheetwashfreq
       , height=4, width=6)

#####ACE#####
# plot the sheetwashfreq and gender against ACE
plot_ace_gender_sheetwashfreq <- ggplot(samp_dat_wdiv) + geom_boxplot(aes(x=sheetwashfreq_binned, y=ACE)) +
  facet_grid(~factor(`sex`, levels=c("female","male"))) +
  xlab("Sheet Wash Frequency") +
  scale_x_discrete(limits = c("low", "medium", "high"))
...
# run the 2-way ANOVA
ace_sheetwashfreq_gender <- lm(ACE ~ `sex`*`sheetwashfreq_binned`, data=samp_dat_wdiv)
...
#save plot
ggsave(filename = "2B_plot_ace.png"
       , plot_ace_gender_sheetwashfreq
       , height=4, width=6)

#####Simpson#####
# plot the sheetwashfreq and gender against Simpson
plot_simpson_gender_sheetwashfreq <- ggplot(samp_dat_wdiv) + geom_boxplot(aes(x=sheetwashfreq_binned, y=Simpson)) +
  facet_grid(~factor(`sex`, levels=c("female","male"))) +
  xlab("Sheet Wash Frequency") +
  scale_x_discrete(limits = c("low", "medium", "high"))
...
# run the 2-way ANOVA
simpson_sheetwashfreq_gender <- lm(Simpson ~ `sex`*`sheetwashfreq_binned`, data=samp_dat_wdiv)
...
#save plot
ggsave(filename = "2B_plot_simpson.png"
       , plot_simpson_gender_sheetwashfreq
       , height=4, width=6)

#####InvSimpson#####
# plot the sheetwashfreq and gender against InvSimpson
plot_invsimp_gender_sheetwashfreq <- ggplot(samp_dat_wdiv) + geom_boxplot(aes(x=sheetwashfreq_binned, y=InvSimpson)) +
  facet_grid(~factor(`sex`, levels=c("female","male"))) +
  xlab("Sheet Wash Frequency") +
  scale_x_discrete(limits = c("low", "medium", "high"))
...
# run the 2-way ANOVA
invsimp_sheetwashfreq_gender <- lm(InvSimpson ~ `sex`*`sheetwashfreq_binned`, data=samp_dat_wdiv)
...
#save plot
ggsave(filename = "2B_plot_invsimp.png"
       , plot_invsimp_gender_sheetwashfreq
       , height=4, width=6)

#####Fisher#####
# plot the sheetwashfreq and gender against Fisher
plot_fisher_gender_sheetwashfreq <- ggplot(samp_dat_wdiv) + geom_boxplot(aes(x=sheetwashfreq_binned, y=Fisher)) +
  facet_grid(~factor(`sex`, levels=c("female","male"))) +
  xlab("Sheet Wash Frequency") +
  scale_x_discrete(limits = c("low", "medium", "high"))
...
# run the 2-way ANOVA
fisher_sheetwashfreq_gender <- lm(Fisher ~ `sex`*`sheetwashfreq_binned`, data=samp_dat_wdiv)
...
#save plot
ggsave(filename = "2B_plot_fisher.png"
       , plot_fisher_gender_sheetwashfreq
       , height=4, width=6)