...
female_low_ASVs <- core_members(dorms_low_female, detection=0.001, prevalence = 0.75)
male_low_ASVs <- core_members(dorms_low_male, detection=0.001, prevalence = 0.75)
