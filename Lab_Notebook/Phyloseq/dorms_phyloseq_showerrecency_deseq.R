...
dorms_final <- subset_samples(dorms_filt_nolow_samps, !is.na(last_shower_binned))
...
## Saving
save(dorms_final, file="dorms_final_showerrecency_deseq.RData")
save(dorms_rare, file="dorms_rare_showerrecency_deseq.RData")
