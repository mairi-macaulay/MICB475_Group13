...
#no medium#
phylo_nomedium <- subset_samples(sample_data(dorms_rare), sheetwashfreq_binned %in% c("low", "high"))
#no low#
phylo_nolow <- subset_samples(sample_data(dorms_rare), sheetwashfreq_binned %in% c("medium", "high"))
#no high#
phylo_nohigh <- subset_samples(sample_data(dorms_rare), sheetwashfreq_binned %in% c("low", "medium"))
